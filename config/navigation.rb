...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :dich_vu, t('dich_vu'), dich_vu_path
    primary.item :chon_game, t('chon_game'), chon_game_path
    primary.item :dat_thue, t('dat_thue'), dat_thue_path
    primary.item :thue_phu_kien, t('thue_phu_kien'), thue_phu_kien_path
